...
// describe("App", () => {
  ...
  // });
  //
  // it.skip("should pass a filmData prop to the Background component", () => {
  //   let backgroundProps = Object.keys(wrapper.find("Background").node.props);
  //
  //   expect(backgroundProps.includes("filmData")).toEqual(true);
  // });
  //
  // it.skip("should render a Controls component", () => {
  //   expect(wrapper.find("Controls").length).toEqual(1);
  // });
  //
  // it.skip("should pass selectCategory, clickBtn, favoriteCards, and favFunc props to the Controls component", () => {
  ...
  // });
  //
  // it.skip("should render a CardDisplay component", () => {
  //   expect(wrapper.find("CardDisplay").length).toEqual(1);
  // });
  //
  // it.skip("should pass itemData, favorites, favCards, favClicked, and clickCard props to CardDisplay component", () => {
  ...
  //   expect(cdProps.includes("clickCard")).skip.toEqual(true);
  // });
  //
  // it.skip("should have a state with properties of planetData, peopleData, vehicleData, filmData, favoriteCards, itemData, and favClicked", () => {
  ...
  // });
  //
  // it.skip("should have the correct default state values", () => {
